...
import type { CalculatedAbility, CalculatedSavingThrow, CalculatedSingleSkill, ComputedEntity, ProviderLocation, StandardEntity, EntityInstance } from '@zukus/core'
...
function CharacterScreenDesktopContent() {
  ...
  // Build tabs for the tabbed content box
  const tabs: TabItem[] = []
...
/**
 * Pantalla de personaje para desktop web (nuevo layout).
 * Layout: DnD Beyond inspired with horizontal stats bar, left columns, and tabbed content box.
