...
export function ChatScreenDesktop() {
  ...
  if (!hasMessages) {
    return (
      <YStack flex={1} backgroundColor={themeColors.background} justifyContent="center" alignItems="center" padding={24}>
        <YStack width="100%" maxWidth={MAX_WIDTH} gap={16}>
          <Text color="$placeholderColor" fontSize={15} textAlign="center">
            Pregunta lo que quieras
          </Text>

          {errorText && (
            <Text color="$red10" fontSize={13} textAlign="center">{errorText}</Text>
          )}
  ...
  return (
    <YStack flex={1} backgroundColor={themeColors.background}>
      <YStack flex={1} alignItems="center">
        <YStack flex={1} width="100%" maxWidth={MAX_WIDTH} paddingHorizontal={16}>
          <ScrollView
            ref={scrollRef}
            style={{ flex: 1 }}
